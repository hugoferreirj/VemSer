...
public class EmailService {
  ...
  public String getContentFromTemplateExercicio1(Pessoa pessoa) throws IOException, TemplateException {
    Map<String, String> dados = new HashMap<>();
  ...
  public String enviarEmailFazerAlgoRelacionadoAoEndereco(Pessoa pessoa, String mensagem) throws IOException, TemplateException {
    Map<String, String> dados = new HashMap<>();
    dados.put("nome",  pessoa.getNome());
